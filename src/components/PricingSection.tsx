    ...
    <section id="priser" className="py-32 px-6 bg-preik-surface transition-colors duration-200">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {/* Starter */}
          <div className="bg-preik-bg rounded-3xl border border-preik-accent p-8 relative overflow-hidden flex flex-col">
          ...
          {/* Vekst */}
          <div className="bg-preik-bg rounded-3xl border border-preik-border p-8 relative overflow-hidden flex flex-col">
            <div className="relative flex flex-col flex-1">
              <div className="mb-6 h-7" />
