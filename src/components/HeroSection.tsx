  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-preik-bg transition-colors duration-200">
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20">
        <a
          href="#losninger"
          className="flex flex-col items-center gap-2 text-preik-text-muted hover:text-preik-text transition-colors"
        >
      ...
      <div className="relative z-10 flex min-h-screen items-center pt-32 pb-24 px-6">
        <div className="max-w-6xl mx-auto w-full grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          {/* Right - Animated chat */}
          <ScrollReveal animation="right" delay={200} className="flex justify-center lg:justify-end">
            <AnimatedChat />
          </ScrollReveal>
        </div>
      </div>
