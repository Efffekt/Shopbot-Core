      ...
      <main className="flex-1 flex items-center justify-center px-6 pb-24">
        <div className="w-full max-w-md">
          <div className="text-center mb-8 space-y-2">
            <div className="h-9 w-32 bg-preik-border rounded animate-pulse mx-auto" />
            <div className="h-5 w-52 bg-preik-border rounded animate-pulse mx-auto" />
          </div>
          ...
          <div className="mt-6 flex justify-center">
            <div className="h-4 w-52 bg-preik-border rounded animate-pulse" />
          </div>
        </div>
      </main>
    </div>
