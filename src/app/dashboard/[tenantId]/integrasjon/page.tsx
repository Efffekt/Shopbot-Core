...
export default function IntegrationPage() {
  ...
  const generateEmbedCode = () => {
    ...
    if (config.privacyUrl) {
      attrs.push(`data-privacy-url="${config.privacyUrl}"`);
    }
        ...
        <div className="space-y-6">
          ...
          <div className="bg-preik-surface rounded-2xl border border-preik-border p-6">
            ...
            <div className="mb-6 p-4 bg-preik-bg rounded-xl border border-preik-border space-y-4">
              <p className="text-sm font-medium text-preik-text">
                {config.theme === "dark" ? "Mørk modus-farger" : config.theme === "light" ? "Lys modus-farger" : "Fargetilpasning"}
              </p>
              {config.theme === "auto" && (
                <p className="text-xs text-preik-text-muted">Fargene brukes i både lys og mørk modus.</p>
              )}
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <input
                    type="color"
                    value={config.bgColor || (config.theme === "dark" ? "#111827" : "#F9FAFB")}
                  ...
                  <input
                    ...
                    placeholder={config.theme === "dark" ? "#111827" : "#F9FAFB"}
                  />
                  {config.bgColor && (
                    <button
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <input
                    type="color"
                    value={config.surfaceColor || (config.theme === "dark" ? "#1F2937" : "#FFFFFF")}
                  ...
                  <input
                    ...
                    onChange={(e) => updateConfig("surfaceColor", e.target.value)}
                    className="flex-1 px-3 py-2 bg-preik-surface border border-preik-border rounded-lg text-sm text-preik-text font-mono"
                    placeholder={config.theme === "dark" ? "#1F2937" : "#FFFFFF"}
                  />
                  {config.surfaceColor && (
                    <button
          ...
          {/* Privacy */}
          <div className="bg-preik-surface rounded-2xl border border-preik-border p-6">
            <h2 className="text-lg font-semibold text-preik-text mb-6">Personvern</h2>
            <div>
              <label className="flex items-center gap-1.5 text-sm font-medium text-preik-text mb-2">
                Personvernlenke
                <Tooltip text="URL til personvernerklæringen som vises i chatwidgeten. La stå tom for å bruke Preiks standard personvernerklæring." />
              </label>
              <input
                type="url"
                ...
                className="w-full px-3 py-2 bg-preik-bg border border-preik-border rounded-lg text-sm text-preik-text"
                placeholder="https://dinside.no/personvern"
              />
              <p className="text-xs text-preik-text-muted mt-1">
                Widgeten viser en &quot;Personvern&quot;-lenke i bunnen. Uten egen URL brukes{" "}
                <a href="https://preik.ai/personvern" target="_blank" rel="noopener noreferrer" className="text-preik-accent hover:underline">
                  preik.ai/personvern
                </a>.
              </p>
            </div>
